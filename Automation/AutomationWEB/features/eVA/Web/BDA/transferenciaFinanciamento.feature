Feature: Solicitar transferencia de financiamento no site

  Scenario: Solicitar transferencia de financiamento através das intenções
    Given que acessei o chatbot do eva (Web)
    When eu digitar a intencao "<intent>"
    And enviar a mensagem
    Then validar conteudo (ballon 3) "Uma pessoa do time BV pode te ajudar com a transferência do seu financiamento de veículo. É só clicar no botão abaixo que eu chamo aqui pra você. 😃"
