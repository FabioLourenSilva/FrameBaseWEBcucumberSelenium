Feature: Informe de rendimentos no app
  ...
  Scenario: Solicitar informe de rendimentos (Financiamento de veículos)
    ...
    And validar conteudo (ballon 5) "Se você tem um financiamento, pode pegar seu informe para o Imposto de Renda no site BV. É só:"
    And validar conteudo (ballon 5) "Acessar a Minha BV (minha.bv.com.br) com CPF e senha"
