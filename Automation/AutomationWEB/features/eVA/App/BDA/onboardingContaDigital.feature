Feature: Onboarding no app
  ...
  Scenario: Solicitar abertura de conta (intenções)
    ...
    And validar conteudo (ballon 3) "Por enquanto, só quem recebeu um convite pra abrir a conta consegue fazer o cadastro no app."
    And validar conteudo (ballon 4) "Para abrir sua conta pelo app, é só:"
