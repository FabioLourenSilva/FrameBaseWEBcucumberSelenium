Feature: Boleto DDA App
  ...
  Scenario: Desativar boleto dda através das intenções
    ...
    And validar conteudo (ballon 3) "Depois disso, é só seguir as instruções na tela. Quando terminar, seus boletos digitais não irão mais aparecer no Organizador."
