Feature: Credito pessoal APP

  @CT1-CREDITO-PESSOAL-APP
  Scenario: Solicitar credito pessoal atraves das intencoes
    ...
    And validar conteudo (ballon 3) "Aqui no BV você tem várias vantagens:"
