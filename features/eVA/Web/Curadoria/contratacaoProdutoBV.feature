Feature: Contratação de produto BV WEB

  @CT1-CONTRATACAO-PROD-BV-WEB
  ...
  Scenario: Solicitar contratação dos produtos BV (Abrir conta)
    ...
    Then validar conteudo (ballon 5) "A conta BV é grátis e 100% digital. Para abrir a sua , você deve acessar o app banco BV. Depois, é só:"
  ...
  Scenario: Solicitar contratação dos produtos BV (Cartão de crédito)
    ...
    And validar conteudo (ballon 5) "Pra pedir, você precisa acessar a área de Cartões aqui no site e escolher o que mais combina com você."

  @CT4-CONTRATACAO-PROD-BV-WEB
  ...
  Scenario: Solicitar contratação dos produtos BV (Financiamento)
    ...
    And validar conteudo (ballon 5) "Alteração de dados cadastrais"
    And validar conteudo (ballon 5) "Renegociação"

  @CT6-CONTRATACAO-PROD-BV-WEB
