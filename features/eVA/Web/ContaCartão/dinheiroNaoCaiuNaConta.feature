Feature: Dinheiro não caiu na conta web

  @CT1-DINHEIRO-N-CAIU-CONTA-WEB
  ...
  Scenario: Informar que o dinheiro não caiu na conta, até o transbordo
    ...
    Then validar conteudo (ballon 5) "Antes de te transferir para uma pessoa do time BV, preciso de quatro informações."