Feature: Problemas com organizador no site
...
#      | Os valores do meu DDA estão incorretos no organizador        |
  ...
  Scenario: Perguntar sobre problemas com o organizador e problemas em desativar DDA
    ...
    And validar conteudo (ballon 5) "Para desativar o Boleto Digital (DDA), você precisa ir no app BV e:"
    And validar conteudo (ballon 5) "Acessar a tela inicial"
    And validar conteudo (ballon 5) "Tocar em Organizar contas"
