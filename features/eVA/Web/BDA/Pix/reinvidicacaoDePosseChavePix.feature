Feature: Reinvidicação de posse da chave pix site
  ...
  Scenario: Solicitar reivindicação de posse da chave pix através das intenções
    ...
    And validar conteudo (ballon 3) "Pra resolver isso, é só continuar o registro da sua chave pelo app banco BV e tocar no botão Pedir posse da chave quando ele aparecer."
    And validar conteudo (ballon 3) "Em até 14 dias, a gente te avisa a resposta pelo app mesmo. 😉"
