...
//Validar balões de conteudo entrada de dados no script
    ...
    public void validarConteudoTrigesimoBalao(String conteudo) {
        waitElementAppeared(thirtiethBallon);
        aux = getDriver().findElement(thirtiethBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoPrimeiroBalao(String conteudo) {
        waitElementAppeared(thirtyfirstBallon);
        aux = getDriver().findElement(thirtyfirstBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoSegundoBalao(String conteudo) {
        waitElementAppeared(thirtysecondBallon);
        aux = getDriver().findElement(thirtysecondBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoTerceiroBalao(String conteudo) {
        waitElementAppeared(ThirtythirdBallon);
        aux = getDriver().findElement(ThirtythirdBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoQuartoBalao(String conteudo) {
        waitElementAppeared(thirtyfourthBallon);
        aux = getDriver().findElement(thirtyfourthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoQuintoBalao(String conteudo) {
        waitElementAppeared(thirtyfifthBallon);
        aux = getDriver().findElement(thirtyfifthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoSextoBalao(String conteudo) {
        waitElementAppeared(thirtysixthBallon);
        aux = getDriver().findElement(thirtysixthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoSetimoBalao(String conteudo) {
        waitElementAppeared(thirtyseventhBallon);
        aux = getDriver().findElement(thirtyseventhBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoOitavoBalao(String conteudo) {
        waitElementAppeared(thirtyeighthBallon);
        aux = getDriver().findElement(thirtyeighthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoTrigesimoNonoBalao(String conteudo) {
        waitElementAppeared(thirtyninthBallon);
        aux = getDriver().findElement(thirtyninthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuadragesimoBalao(String conteudo) {
        waitElementAppeared(fortiethBallon);
        aux = getDriver().findElement(fortiethBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuadragesimoPrimeiroBalao(String conteudo) {
        waitElementAppeared(fortyfirstBallon);
        aux = getDriver().findElement(fortyfirstBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
    public void validarConteudoQuadragesimoSegundoBalao(String conteudo) {
        waitElementAppeared(fortysecondBallon);
        aux = getDriver().findElement(fortysecondBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
    public void validarConteudoQuadragesimoTerceiroBalao(String conteudo) {
        waitElementAppeared(fortythirdBallon);
        aux = getDriver().findElement(fortythirdBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuadragesimoQuartoBalao(String conteudo) {
        waitElementAppeared(fortyfourthBallon);
        aux = getDriver().findElement(fortyfourthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
    public void validarConteudoQuadragesimoQuintoBalao(String conteudo) {
        waitElementAppeared(fortyfifthBallon);
        aux = getDriver().findElement(fortyfifthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
    public void validarConteudoQuadragesimoSextoBalao(String conteudo) {
        waitElementAppeared(fortysixthBallon);
        aux = getDriver().findElement(fortysixthBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
    public void validarConteudoQuadragesimoSetimoBalao(String conteudo) {
        waitElementAppeared(fortyseventhBallon);
        aux = getDriver().findElement(fortyseventhBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuadragesimoOitavoBalao(String conteudo) {
        waitElementAppeared(fortyeityBallon);
        aux = getDriver().findElement(fortyeityBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
    public void validarConteudoQuadragesimoNonoBalao(String conteudo) {
        waitElementAppeared(fortyNineBallon);
        aux = getDriver().findElement(fortyNineBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuintagesimoBalao(String conteudo) {
        waitElementAppeared(fiftiethBallon);
        aux = getDriver().findElement(fiftiethBallon);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuintagesimoPrimeiroBalao(String conteudo) {
        waitElementAppeared(fifthfirst);
        aux = getDriver().findElement(fifthfirst);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }

    public void validarConteudoQuintagesimoSegundoBalao(String conteudo) {
        waitElementAppeared(fifthsecond);
        aux = getDriver().findElement(fifthsecond);
        System.out.println(aux.getText());
        validateConditionTrue("texto errado", aux.getText().contains(conteudo));
    }
}
