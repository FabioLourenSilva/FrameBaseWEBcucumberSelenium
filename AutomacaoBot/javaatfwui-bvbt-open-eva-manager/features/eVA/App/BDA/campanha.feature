Feature: Campanha app
  ...
  Scenario: Solicitar campanha através das intenções
    ...
    And validar conteudo (ballon 3) "Mas, se esse tempo passou e você ainda não recebeu o saldo em conta, posso chamar uma pessoa do time BV pra te ajudar."
