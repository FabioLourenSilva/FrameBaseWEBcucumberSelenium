Feature: Solicitar cartão de crédito no app
  ...
  Scenario: Solicitar cartão de crédito através das intenções
    ...
    And validar conteudo (ballon 3) "Pra pedir, você precisa acessar o site do BV na área de Cartões e escolher o que mais combina com você."
