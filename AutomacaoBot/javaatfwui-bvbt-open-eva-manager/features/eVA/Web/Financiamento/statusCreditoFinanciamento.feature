Feature: Status crédito financiamento Web

  @CT1-CREDITO-FINANCIAMENTO-WEB
  ...
  Scenario: Solicitar status do meu financiamento
    ...
    Then validar conteudo (ballon 5) "Certo! Você pode acompanhar o status do pedido de financiamento de veículo pelo app BV, é só"
    And validar conteudo (ballon 5) "Acessar a área logada do app"
    ...
    And validar conteudo (ballon 5) "Lá, você consegue ver suas solicitações finalizadas e em andamento."
