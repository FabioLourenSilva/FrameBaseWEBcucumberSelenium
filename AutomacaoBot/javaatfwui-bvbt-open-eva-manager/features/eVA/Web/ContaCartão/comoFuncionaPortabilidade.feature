Feature: Como funciona a portablidade (Web)

  @CT1-COMO-FUNCIONA-PORTABILIDADE-WEB
  Scenario: Perguntar como funciona a portabilidade através das intenções
    ...
    And validar conteudo (ballon 3) "Para isso, é só pedir a portabilidade pelo app BV. O processo é bem simples e dura poucos minutos."
  ...
  @CT2-COMO-FUNCIONA-PORTABILIDADE-WEB
  Scenario: Perguntar como funciona e como pedir a portabilidade (Já tentei isso)
    ...
    And validar conteudo (ballon 6) "Para receber o seu salário na sua Conta BV, você precisa fazer a portabilidade. É só acessar o app BV no seu celular e:"
    And validar conteudo (ballon 6) "Ir na tela inicial"
  ...
  @CT3-COMO-FUNCIONA-PORTABILIDADE-WEB
  ...
  @CT4-COMO-FUNCIONA-PORTABILIDADE-WEB
  ...
  @CT5-COMO-FUNCIONA-PORTABILIDADE-WEB
  Scenario: Perguntar como funciona e como cancelar a portabilidade
    Given que acessei o chatbot do eva (Web)
    And eu digitar a intencao "O que é portabilidade de salário?"
    And enviar a mensagem
