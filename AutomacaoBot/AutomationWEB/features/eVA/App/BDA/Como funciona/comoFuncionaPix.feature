Feature: Como funciona o pix app
...
#      | estou com duvidas sobre a chave pix      |
  ...
  Scenario: Perguntar como funciona o pix e duvidas sobre transferencias (Valor voltou pra conta) até o transbordo
    ...
    And validar conteudo (ballon 11) "Neste caso, você precisa da ajuda de uma pessoa do time BV. O que prefere fazer? 😉"
  ...
  Scenario: Perguntar como funciona o pix e duvidas sobre pagamento qrcode (como pagar) até o transbordo
    ...
    And validar conteudo (ballon 7) "Pagar um QR Code Pix por aqui é simples. É só:"
    And validar conteudo (ballon 7) "Ir na tela inicial do app e escolher a opção Pagar contas 👉 QR Code Pix"
  ...
  Scenario: Perguntar como funciona o pix e duvidas sobre pagamento qrcode (como criar) até o transbordo
    ...
    And validar conteudo (ballon 7) "É muito fácil criar um QR Code Pix pra receber um pagamento na sua Conta BV."
    And validar conteudo (ballon 7) "Primeiro, você precisa ter uma chave Pix cadastrada aqui. Depois, é só:"
