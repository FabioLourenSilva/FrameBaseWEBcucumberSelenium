Feature: Portabilidade de chave Pix app
  ...
  Scenario: Solicitar portabilidade da chave pix através das intenções
    ...
    And validar conteudo (ballon 3) "Se você tem cadastro em outra instituição e agora quer ter sua chave Pix com a gente, é só pedir a portabilidade aqui pelo app."
    And validar conteudo (ballon 3) "Ir na tela inicial e tocar na opção Pix"
    And validar conteudo (ballon 3) "Selecionar Minhas chaves 👉 Portabilidade e reivindicação 👉Solicitar portabilidade"
