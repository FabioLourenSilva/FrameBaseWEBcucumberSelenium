Feature: Entrega amigável (APP)

  @CT1-ENTREGA-AMIGAVEL-APP
  ...
  Scenario: Perguntar sobre entrega amigável (Saber mais sobre entrega amigável), até o transbordo
    ...
    And validar conteudo (ballon 7) "Por favor, espere um pouquinho que uma pessoa do nosso time já vai falar com você."